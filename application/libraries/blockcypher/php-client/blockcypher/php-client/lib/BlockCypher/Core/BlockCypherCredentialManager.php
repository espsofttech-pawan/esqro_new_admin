...
/**
 * Class BlockCypherCredentialManager
 *
 * BlockCypherCredentialManager holds all the credential information in one place.
 *
...
class BlockCypherCredentialManager
{
     ...
     * @return $this
     */
    public function setCredentialObject(TokenCredential $credential, $userId = null, $default = true)
    {
