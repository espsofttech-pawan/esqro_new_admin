...
/**
 * Class CreateAndDeleteForwardingAddressTest
 * @package sample\Test\Functional\transaction
 */
class CreateAndDeleteForwardingAddressTest extends WebTestCase
{
    ...
    public function testCreateAndDeleteForwardingAddress()
    {
