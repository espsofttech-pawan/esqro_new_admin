...
/**
 * Class GetHDWalletAsAddressBalanceTest
 * @package sample\Test\Functional\wallet
 */
class GetHDWalletAsAddressBalanceTest extends WalletSampleTestCase
{
    ...
    public function testGetHDWalletAsAddressBalance()
    {
