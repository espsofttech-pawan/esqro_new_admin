...
/**
 * Class CreateAndListForwardingAddressTest
 * @package sample\Test\Functional\transaction
 */
class CreateAndListForwardingAddressTest extends WebTestCase
{
    ...
    public function testCreateAndListForwardingAddress()
    {
