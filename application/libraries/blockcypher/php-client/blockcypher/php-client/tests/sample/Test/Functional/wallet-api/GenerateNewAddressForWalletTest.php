...
/**
 * Class GenerateNewAddressForWalletTest
 * @package sample\Test\Functional\wallet
 */
class GenerateNewAddressForWalletTest extends WalletSampleTestCase
{
    ...
    public function testGenerateNewAddressForWallet()
    {
