...
class TXInputTest extends ResourceModelTestCase
{
    ...
    public function testGetters($obj)
    {
        ...
        $this->assertEquals($obj->getWalletToken(), "2391f84fe7cc4de7be07b35a8a570dd6");
