...
class WalletTest extends ResourceModelTestCase
{
    ...
    public static function getJson($addresses=array())
    {
        ...
        */
        ...
        //return '{"token":"2391f84fe7cc4de7be07b35a8a570dd6","name":"alice","addresses":["18VAyux27CiWQnmYumZeTKNcaw6opvKRLq","1JcX75oraJEmzXXHpDjRctw3BX6qDmFM8e"],"error":"","errors":[]}';
        ...
        return '{"token":"2391f84fe7cc4de7be07b35a8a570dd6","name":"alice","addresses":'.json_encode($addresses, true).',"error":"","errors":[]}';
    }
