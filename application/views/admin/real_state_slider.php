            ...
            <section class="content">
              ...
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Manage Real State Promotion Page Slider</h3>
                  <div style="float: right;">
                    <?php $pageType = base64_encode("real_state"); ?>
