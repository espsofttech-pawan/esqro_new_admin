...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <?php foreach ($completedTradeInfo as $key => $arr){ ?>        
              ...
              <div class="modal-body" id="preview_div">
                <table class="table table-bordered">
                  <tr>
                   ...
                   <tr>
                    <th>Check Escrow transacion</th>
                    <td>
                      <?php if($arr['crypto_currency'] == "ETH"){ ?>
                        <a href="https://rinkeby.etherscan.io/tx/<?php echo $arr['escrow_hash'] ?>" target="_blank">
                          <button class="btn btn-success">Check Transaction</button>
                        </a>
                      <?php }else if($arr['crypto_currency'] == "BTC"){ ?>
                        <a href="https://www.blockchain.com/btc/tx/<?php echo $arr['escrow_hash'] ?>" target="_blank">
                          <button class="btn btn-success">Check Transaction</button>
                        </a>
                      <?php } ?>
                    </td>
                   ...
                   <tr>
                    <th>Check Release transacion</th>
                    <td>
                      <?php if($arr['crypto_currency'] == "ETH"){ ?>
                        <a href="https://rinkeby.etherscan.io/tx/<?php echo $arr['release_hash'] ?>" target="_blank">
                          <button class="btn btn-success">Check Transaction</button>
                        </a>
                      <?php }else if($arr['crypto_currency'] == "BTC"){ ?>
                        <a href="https://www.blockchain.com/btc/tx/<?php echo $arr['release_hash'] ?>" target="_blank">
                          <button class="btn btn-success">Check Transaction</button>
                        </a>
                      <?php } ?>
                    </td>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Completed Trade</li>
                </ol>
            </section>
            ...
            <section class="content">
                ...
                <div class="row">
                    <div class="col-lg-12 col-xs-12">
                        <!-- small box -->
                        <h2>Completed Trade</h2>

                        <!-- Table code start -->
                        <div class="box">
                            <div class="box-header">
                              <h3 class="box-title">Completed Trade</h3>
                            </div>
                            <!-- /.box-header -->
