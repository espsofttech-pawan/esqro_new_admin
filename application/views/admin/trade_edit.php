                ...
                <form class="form-horizontal" method="post" action="">
                 ...
                 <script type="text/javascript">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <?php echo __webtxt("Other information you wish to tell about your trade. Example 1: "); ?><b><?php echo __webtxt("This advertisement is only for cash trades. If you want to pay online, contact "); ?>localcointrade.com</b><?php echo __webtxt(". Example 2: "); ?><b><?php echo __webtxt("Please make request only when you can complete the payment with cash within 12 hours"); ?></b>.
                    </div>
                  </div>
