...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <?php foreach ($cancelledTradeInfo as $key => $arr){ ?>        
                ...
                <table class="table table-bordered">
                  <tr>
                   ...
                   <tr>
                    ...
                    <td><?php echo $arr['escrow_hash'] ?></td>
                  </tr>
                   <tr>
                    <th>Check Release transacion</th>
                    <td><?php echo $arr['release_hash'] ?></td>
                  </tr>
                   <tr>
                    <th>Created Date</th>
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="active">Cancelled Trade</li>
                </ol>
            </section>
            ...
            <section class="content">
                ...
                <div class="row">
                    <div class="col-lg-12 col-xs-12">
                        <!-- small box -->
                        <h2>Cancelled Trade</h2>

                        <!-- Table code start -->
                        <div class="box">
                            <div class="box-header">
                              <h3 class="box-title">Cancelled Trade</h3>
                            </div>
                            <!-- /.box-header -->
