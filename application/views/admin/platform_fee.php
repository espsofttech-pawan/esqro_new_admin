...
<head>
  ...
  <title>Localbitcoin | User Profile</title>
              ...
              <div class="active tab-pane" id="settings">
                ...
                <form class="form-horizontal" method="post" action="<?php echo site_url().'admin/home/platform_fee/'; ?>">
                  ...
                  <div class="form-group">
                    <label class="col-sm-4 control-label">Plateform Fee(BTC)</label>
                    <div class="col-sm-8">
                  ...
                  <div class="form-group">
                    <label class="col-sm-4 control-label">Incoming Transaction(BTC)</label>
                    <div class="col-sm-8">
                      <input type="text" required name="incoming_txn_fee" id="incoming_txn_fee" value="<?php echo (!empty($feeInfo['incoming_txn_fee']) ? $feeInfo['incoming_txn_fee'] : ''); ?>" class="form-control" placeholder="Incoming Transaction Fee">
                    </div>
                  </div>
...
<!--<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>-->
  ...
  <script type="text/javascript">
    ...
    $('#incoming_txn_fee').keypress(function(event) {
        if (((event.which != 46 || (event.which == 46 && $(this).val() == '')) ||
                $(this).val().indexOf('.') != -1) && (event.which < 48 || event.which > 57)) {
            event.preventDefault();
        }
