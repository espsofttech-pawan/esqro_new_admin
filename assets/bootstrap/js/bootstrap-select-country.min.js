var countrypicker=function(a) {
    ...
    T=function(S) {
        a(this).each(function(S, n) {
            var e=a(n), I=e.data("flag"), t=c, O=e.data("countries");
            ...
            I?(a.each(t, function(a, S) {
                if(S.code == "DZ") { var fixed = "selected='selected'"; }
                ...
                a("a.option-with-flag").each(function() {
                    ...
                    if(S.children(".inline-flag").length<=0) {
                        var n=S.data("tokens").toLowerCase(), e=a('<span class="inline-flag flag '+n+'"></span>');
                        S.prepend(e)
                    }
                }
                )
